...
<div> 
    ...
    <div class="column1-unit">
        <div class="contactform">
            ...
            <p><label class="left">Note viaggio:</label><label class="contenitore">&nbsp<b>{$note} //cambiare css</b></p></label><br><br><br>
            ...
            {/if}
            {if $isPasseggero}
                <p><input type="button" id="cancellami" class="button" name1="{$num_viaggio}" name2="{$username_passeggero}" value="Cancellami" tabindex="1" /><br><br></p>
            {/if}
        </div>
    </div>
    ...
    <div class="colomn1-unit">
        <div class="contactform">
            {if $isGuidatore || $isAmministratore}
                <div>
                    <p><input type="button" class="elimina_viaggio button_center" name="{$num_viaggio}" value="elimina" tabindex="8" /></p>
                </div>
            {/if}
            {if $indietro}
                <div>
