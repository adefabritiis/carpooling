<?php /* Smarty version 2.6.26, created on 2013-12-23 15:17:06
...
&nbsp</h1>
    <div class="column1-unit">
        <div class="contactform">            
            ...
            <div>
                <p><input type="button" class="elimina_veicolo button" tabindex="1" value="Elimina veicolo" name="<?php echo $this->_tpl_vars['targa']; ?>
"/></p>
            </div>
        </div>              
    </div>
